...
page = st.sidebar.radio(
    ...
    index=["Project Details", "Upload BRD", "User Stories", "Acceptance Criteria", "Test Cases", "Code"].index(st.session_state.page)
)
...
if page == "Project Details":
    ...
    st.session_state.project_details["Programming Language"] = st.text_input("Programming Language", value=st.session_state.project_details.get("Programming Language", "Python"))
...
# Tab 6: Code
    ...
    if not st.session_state.test_cases or not st.session_state.project_details.get("Programming Language"):
        ...
        st.markdown("The AI agent will now write the code based on the project requirements and test cases.")
        ...
        if st.session_state.generated_code:
            ...
            st.code(st.session_state.generated_code, language=st.session_state.project_details.get("Programming Language", "python"))
